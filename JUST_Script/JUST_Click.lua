...
gui.Name = "PSXO Clicker"
gui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
gui.ResetOnSpawn = false

local frame = Instance.new("Frame")
frame.Size = UDim2.new(0, 120, 0, 160) -- Increased height for toggle button
...
statusLabel.Size = UDim2.new(0, 52.5, 0, 20)
...
statusValue.Size = UDim2.new(0, 52.5, 0, 20)
statusValue.Position = UDim2.new(0, 62.5, 0, -5)
...
plusButton.Position = UDim2.new(0, 5, 0, 20)
plusButton.Text = "+"
...
intervalLabel.Size = UDim2.new(0, 60, 0, 20)
intervalLabel.Position = UDim2.new(0, 30, 0, 20)
...
minusButton.Position = UDim2.new(0, 95, 0, 20)
minusButton.Text = "-"
...
resetPositionButton.Size = UDim2.new(0, 52.5, 0, 20)
resetPositionButton.Position = UDim2.new(0, 62.5, 0, 45)
...
positionLabel.Size = UDim2.new(0, 110, 0, 20)
positionLabel.Position = UDim2.new(0, 5, 0, 70)
...
toggleButton.Size = UDim2.new(0, 110, 0, 20)
