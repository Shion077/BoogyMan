...
AntiAfkButton.Size = UDim2.new(0, 85, 0, 25)
...
local AfkAfkTimeLabel.Text = Instance.new("TextLabel", content)
AfkTimeLabel.Text.Size = UDim2.new(0, 85, 0, 25)
AfkTimeLabel.Text.Position = UDim2.new(0, 95, 0, 200)
AfkTimeLabel.Text.Text = "0:0:0"
AfkTimeLabel.Text.BackgroundColor3 = Color3.fromRGB(40, 120, 40)
AfkTimeLabel.Text.TextColor3 = Color3.fromRGB(255, 255, 255)
AfkTimeLabel.Text.Font = Enum.Font.SourceSansBold
AfkTimeLabel.Text.TextSize = 15
...
task.spawn(function()
    while true do
        ...
        if timerRunning then
            ...
            timeLabel.Text = string.format("%d:%d:%d", hours, minutes, seconds)
        end
    end
end)
