...
createBoostButton("SuperLucky", "Super Lucky", -5, "Super Lucky")
createBoostButton("TripleCoins", "Triple Coins", 20, "Triple Coins")
createBoostButton("TripleDamage", "Triple Damage", 45, "Triple Damage")
