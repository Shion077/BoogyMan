...
local function ReverseDupeDiamonds()
    local amount = 999999999999

    -- Withdraw first
    print("💸 Withdrawing", amount, "diamonds...")
    BankWithdraw:InvokeServer(DepositBankID, {}, amount)

    -- Deposit back after 0.5 sec
    task.delay(0.5, function()
        print("💸 Depositing back", amount, "diamonds...")
        BankDeposit:InvokeServer(WithdrawBankID, {}, amount)
    end)
end
...
local DupeBTN = Instance.new("TextButton", content)
DupeBTN.Size = UDim2.new(0, 110, 0, 20)
DupeBTN.Position = UDim2.new(0, 5, 0, -5)
DupeBTN.BackgroundColor3 = Color3.fromRGB(50, 120, 50)
...
DupeBTN.MouseButton1Click:Connect(DupeDiamonds)

local ReverseBTN = Instance.new("TextButton", content)
ReverseBTN.Size = UDim2.new(0, 110, 0, 20)
ReverseBTN.Position = UDim2.new(0, 5, 0, 20)
ReverseBTN.BackgroundColor3 = Color3.fromRGB(50, 120, 50)
ReverseBTN.TextColor3 = Color3.fromRGB(255, 255, 255)
ReverseBTN.Text = "ReverseDupe"
ReverseBTN.Font = Enum.Font.GothamBold
ReverseBTN.TextSize = 11
Instance.new("UICorner", ReverseBTN).CornerRadius = UDim.new(0, 6)

-- Connect Dupe function
ReverseBTN.MouseButton1Click:Connect(ReverseDupeDiamonds)
