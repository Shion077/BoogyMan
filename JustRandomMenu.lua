...
--    }, 
    {
        name = "Auto clicker",
        code = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Shion077/BoogyMan/refs/heads/main/AutoClick%26JumpMobile.lua"))()'
    },    
    {
        name = "Server Boost",
        code = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Shion077/BoogyMan/refs/heads/main/BoogyMan%20Boost.lua"))()'
    },
    {
        name = "Auto Hatcher",
        code = 'loadstring(game:HttpGet("https://raw.githubusercontent.com/Shion077/BoogyMan/refs/heads/main/AutoHatch.lua"))()'
    }
}
...
frame.Size = UDim2.new(0, 120, 0, 105) --Add 25 in Hieght if you add 1 button
...
--ExampleBtn.Position = UDim2.new(0, 10, 0, 70) -- add the previous btn Size(0,0,0,20) + Position(0,0,0,60) then add (0,0,0,5) for margin
